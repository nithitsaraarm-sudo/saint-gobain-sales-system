...
|---|---|---|---|---|---|
| V1-P0-001 | P0 | Open gate blocker | Release-blocking runtime/security/browser/PWA tests have not been executed against the target Apps Script deployment, UAT Google Sheets, real roles, and devices. | Cannot prove no data leak, duplicate quote number, export failure, stale cache, or mobile blocker before real-user UAT. | Prepare UAT environment and execute all P0 tests in `TEST_CASES.md`; attach evidence before UAT invite. |
