...
ensurePageData=function(page){if(page==='users'){return loadUsers();}if(page==='customers'){return Promise.all([baseEnsurePageDataForAuth(page),loadFavoriteCustomers()]);}return baseEnsurePageDataForAuth(page);};
