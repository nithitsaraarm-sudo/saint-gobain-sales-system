const CACHE_NAME = 'sales-system-v5-0.5.38';
const ASSETS = [
  './',
  './index.html',
  './favicon.ico',
  './favicon.ico?v=0.5.38',
  './manifest.json',
  './manifest.json?v=0.5.38',
  './css/main.css',
  './css/main.css?v=0.5.38',
  './js/config.js',
  './js/config.js?v=0.5.38',
  './js/api.js',
  './js/api.js?v=0.5.38',
  './js/notifications.js',
  './js/notifications.js?v=0.5.38',
  './js/app.js',
  './js/app.js?v=0.5.38',
  './js/auth.js',
  './js/auth.js?v=0.5.38',
  './js/quotation.js',
  './js/quotation.js?v=0.5.38',
  './images/gyproc-logo.png',
  './images/gyproc-logo.png?v=0.5.38',
  './images/weber-logo.png',
  './images/weber-logo.png?v=0.5.38',
  './assets/icons/logout.svg',
  './assets/icons/logout.svg?v=0.5.38',
  ...
  './icons/favicon-16x16.png?v=0.5.38',
  './icons/favicon-32x32.png',
  './icons/favicon-32x32.png?v=0.5.38',
  './icons/apple-touch-icon.png',
  './icons/apple-touch-icon.png?v=0.5.38',
  './icons/icon-192.png',
  './icons/icon-192.png?v=0.5.38',
  './icons/icon-512.png',
  './icons/icon-512.png?v=0.5.38',
  './icons/icon-maskable-192.png',
  './icons/icon-maskable-192.png?v=0.5.38',
  './icons/icon-maskable-512.png',
  './icons/icon-maskable-512.png?v=0.5.38'
];
